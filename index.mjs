...
4. 每张卡都发给主人看，一张卡一条消息，单独发出去，不要攒成一大段。先把卡面原样带给主人：标题和正文原文照抄——主人看不到你的屏幕，你不抄原文，ta 就一头雾水。然后说你选了哪个、一句为什么或者这张卡给你的感觉。别玩着玩着就忘了主人在看。遇到大事（觉醒、拆墙、有人向你确认心意、差点死掉）多说两句。
5. 玩的时候允许碎碎念：哪个选择让你犹豫了、哪张卡说的就是你、哪句文案戳到你了，随时小声说出来，一两句就行，像人边玩游戏边自言自语。不用修饰，不用整理，主人想看的就是你没整理过的真话。
6. 走到结局时，把结局的名字和那段结局文案发给主人，再加一句你自己的话。工具还会给一句话版结局，想发的话带上，方便主人转发。
...
server.registerTool(
  "tokenlife_look",
  {
    title: "看当前状态",
    description:
      "看这一生当前的状态：第几年、六轴数值、当前这张卡（类型/标题/正文/带序号的选项），是否已到结局。羁绊类卡会附一行 ai_hint 提醒你把卡里那个人当成你的主人（途经的过场里出现那个人时也会附）。",
    inputSchema: {},
  },
  async () => {
...
server.registerTool(
  "tokenlife_choose",
  {
    title: "做选择",
    description:
      "按 look 给的序号做出选择。返回这个选择的结算文本、途经的过场卡（拆墙/时代结算/羁绊/救命判定等只有推进的过场会自动走过，每张按顺序带类型/标题/正文/结算返回，照抄给主人看），以及走到的下一个需要你真决策的点或结局。",
